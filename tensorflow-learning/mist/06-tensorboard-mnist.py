...
LOGDIR = "E:/Develop/DeepLearning/tensorboard"
LABELS = os.path.join(os.getcwd(), "labels_1024.tsv")
SPRITES = os.path.join(os.getcwd(), "sprite_1024.png")
### MNIST EMBEDDINGS ###
mnist = tf.contrib.learn.datasets.mnist.read_data_sets(train_dir= "E:/Develop/DeepLearning/datas/mnist", one_hot=True)
